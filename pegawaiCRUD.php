    ...
    <div class="container bg-light p-2">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item px-3" role="presentation">
                <button class="nav-link active" id="pegawai-tab" data-bs-toggle="tab" data-bs-target="#pegawai" type="button" role="tab" aria-controls="home" aria-selected="true">Pegawai</button>
            </li>
            <li class="nav-item px-3" role="presentation">
                <button class="nav-link" id="PaketBelajar-tab" data-bs-toggle="tab" data-bs-target="#PaketBelajar" type="button" role="tab" aria-controls="profile" aria-selected="false">Paket Pembelajaran</button>
            </li>
            <li class="nav-item px-3" role="presentation">
